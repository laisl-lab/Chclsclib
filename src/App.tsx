          ...
          <form className="space-y-5" onSubmit={handleAuth}>
            <div>
              ...
              <input
                type="email"
                required
                className="block w-full px-3 py-2.5 border border-slate-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-sm text-slate-900 placeholder-slate-400"
